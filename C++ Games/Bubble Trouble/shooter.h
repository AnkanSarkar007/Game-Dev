...
/* Shooter Vars */
const int SHOOTER_START_X = 1000;
const int SHOOTER_START_Y = 1150;
const int SHOOTER_VX = 1000;

/* Game Window Vars */
const int WINDOW_X = 2000;
const int WINDOW_Y = 1250;
...
public:
    Shooter(double position_x, double position_y, double vx_=100, double height=100, double width=60, double head_radius=35, Color color_=COLOR(208, 156, 60))
    {
        // Shooter constructor
        color = color_;
    ...
    {
        // shoot a bullet
        return Bullet(head.getX(), head.getY() - head.getRadius());
    }
